...
export default function TableOfContents({ redirects }) {
  return (
    <article>
      ...
      <p><a href="//jacobford.com">Jacob Ford</a> buys funny little domains and send them to relevant little places. His favorites are when he snags one from the background of fiction.</p>
      <ul>
